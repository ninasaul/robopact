...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Banner Section */}
              <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-6 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`text-center lg:text-left transition-all duration-1000 ease-out ${isLoaded ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-50px]'}`}>
                      <h1 className={`text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-white mb-6 leading-tight transition-all duration-1000 ease-out delay-200 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'}`}>
                {t('hero.title')}
              </h1>
              <p className={`text-xl lg:text-2xl text-neutral-600 dark:text-neutral-300 mb-8 leading-relaxed transition-all duration-1000 ease-out delay-300 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'}`}>
                {t('hero.subtitle')}
              </p>
              <p className={`text-lg text-neutral-600 dark:text-neutral-300 mb-12 leading-relaxed transition-all duration-1000 ease-out delay-400 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'}`}>
                {t('hero.description')}
              </p>
              ...
              <div className={`flex flex-col sm:flex-row gap-4 justify-center lg:justify-start transition-all duration-1000 ease-out delay-500 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'}`}>
                ...
                <Link
                  ...
                  className="bg-white hover:bg-neutral-50 text-neutral-900 font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer"
                >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className={`bg-white dark:bg-neutral-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-neutral-100 dark:border-neutral-700 delay-700 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className={`bg-white dark:bg-neutral-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-neutral-100 dark:border-neutral-700 delay-800 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'}`}>
              <div className="text-center">
            ...
            <div className={`bg-white dark:bg-neutral-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-neutral-100 dark:border-neutral-700 delay-900 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0 translate-y-8'}`}>
              <div className="text-center">
